...
(defun dotspacemacs/user-config ()
  ...
  (setq window-numbering-assign-func
        (lambda () (when (equal (buffer-name) "*Calculator*") 9)));; Window numbering
  ;; Keybindings
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  (global-set-key [f8] 'neotree-toggle) ; Set Neotree toggle key to F8

  (setq neo-theme 'icons) ; Set neotheme to icons

  (add-hook 'c++-mode-hook
            (lambda () (setq flycheck-clang-include-path
                             (list (expand-file-name "/usr/include/")
                                   (expand-file-name "/usr/include/x86_64-linux-gnu/c++/8")
                                   (expand-file-name "/usr/include/c++/8/backward")
                                   (expand-file-name "/usr/lib/gcc/x86_64-linux-gnu/8/include")
                                   (expand-file-name "/usr/local/include")
                                   (expand-file-name "/usr/lib/gcc/x86_64-linux-gnu/8/include-fixed")
                                   (expand-file-name "/usr/include/x86_64-linux-gnu")
                                   (expand-file-name "/usr/include/x86_64-linux-gnu/c++/8")
                                   (expand-file-name "/usr/lib/")
                                   (expand-file-name "/lib/x86_64-linux-gnu")
